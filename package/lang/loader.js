  ...
  load : async function(lang){
   ...
   (function($, window, document) {
      $(function() {
			...
			selector.find("li:nth-child(2) .right select option[value='ru']").text(self.clean(template.settings.lang.ru));
			...
			selector.find("li:nth-child(3) .right select option[value='rus']").text(self.clean(template.settings.game_lang.rus));
